...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onPostCreate(final Bundle savedInstanceState) {
        ...
        final long lastShowDonationTime = prefs.getLong("last_show_donation_time", 0);
        ...
        if (!isFreshInstall && currentVersionCode > storedVersionCode + 90) {
            ...
            final AlertDialog supportDialog = builder2.create();
            final AlertDialog changelogDialog = builder.create();
            changelogDialog.setOnDismissListener(dialog -> {
                if (currentTime - lastShowDonationTime > 14L * 24 * 60 * 60 * 1000) {
